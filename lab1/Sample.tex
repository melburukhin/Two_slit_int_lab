...
\altaffiliation[permanent address: ]{Smith College, 1 Chapin Way, Northampton MA 01063 } % optional second address
% If there were a second author at the same address, we would put another 
% \author{} statement here.  Don't combine multiple authors in a single
% \author statement.
\affiliation{Department of Physics, Smith College, 1 Chapin Way, Northampton MA 01063 }
...
sadlfjkladskfja;woeildkjfadlk \cite{dyson} Fig.\ref{mygreatdata}. $E=mc^2=\alpha \Psi$

\begin{equation}
e = \frac{m^{2}}{c} + \sum lskjdfa +\mathit{123}+{\sin}^{2}\Theta + \vec{F}_{\rm{force \ net}} + \vec{a} + \text{dlsafk fdaslkj}
\label{you}
\end{equation}

looking at Eq.(\ref{you})
...
To prepare manuscripts for the American Journal of Physics (AJP), dkfj
